...
class HermesAdapter:
    ...
    def _get_system_prompt(self, current_lang: str) -> str:
        ...
        prompt = (
            ...
            "• End most substantive answers with ONE specific next step related to the topic. "
            "Do NOT end with generic filler like 'let me know', 'if you have questions', 'feel free to ask', 'so'rang', 'bemalol so'rang', or 'обращайтесь'. "
            "Example: after productivity tips, ask whether to dive into Pomodoro or set up daily tracking; after logging food, offer today's remaining calories or a healthier swap.\n\n"
